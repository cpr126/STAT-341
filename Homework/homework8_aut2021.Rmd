...
1. Pruim problem 3.17 on page 216.   The time $X$ (in seconds) between two randomly selected consecutive cars in a traffic flow model is modeled with PDF 
...
2. Suppose $X \sim Unif(0,1)$. Find $E\left[ -\ln(X) \right]$ using the law of the unconscious probabilist.
